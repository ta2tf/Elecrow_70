...
void ui_Screen_2_Move_screen_init(void)
{
    ...
    lv_obj_add_flag(ui_Arrow_Up_2, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    ...
    lv_obj_add_flag(ui_Arrow_Down_2, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    ...
    lv_obj_add_flag(ui_Arrow_Left_2, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    ...
    lv_obj_add_flag(ui_Arrow_Right_2, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    ...
    lv_img_set_src(ui_Image1, &ui_img_s1_png);
    ...
    ui_Image2 = lv_img_create(ui_Screen_2_Move);
    lv_img_set_src(ui_Image2, &ui_img_n4_png);
    ...
    lv_obj_add_event_cb(ui_Arrow_Up_2, ui_event_Arrow_Up_2, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_Arrow_Down_2, ui_event_Arrow_Down_2, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_Arrow_Left_2, ui_event_Arrow_Left_2, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_Arrow_Right_2, ui_event_Arrow_Right_2, LV_EVENT_ALL, NULL);
