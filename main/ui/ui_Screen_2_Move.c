...
lv_obj_set_style_text_font(ui_Label_X_Position, &lv_font_montserrat_14, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Label_Y_Position, &lv_font_montserrat_14, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Label_Z_Position, &lv_font_montserrat_14, LV_PART_MAIN| LV_STATE_DEFAULT);
